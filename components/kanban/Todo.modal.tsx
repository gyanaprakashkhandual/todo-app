...
export default function TodoFormModal({
  ...
  const [form, setForm] = useState<TodoRequest>({ ...empty, status: defaultStatus });
    ...
    <Portal>
      ...
      >
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
          {/* Header */}
          <View style={s.header}>
            <Text style={s.headerTitle}>{initial ? 'Edit Task' : 'New Task'}</Text>
                      ...
                      style={[
                        s.chip,
                        {
                          backgroundColor: selected
                            ? (colors.isDark ? pc.bgColorDark : pc.bgColor)
                            : colors.surfaceElevated,
                          borderColor: selected ? pc.color : colors.border,
                        },
                      ]}
                    >
                      <Text style={[s.chipText, { color: selected ? pc.color : colors.textSecondary }]}>
                        {pc.label}
                      </Text>
                    </TouchableOpacity>
                  );
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={[
                        ...
                        {
                          backgroundColor: selected
                            ? (colors.isDark ? sc.bgColorDark : sc.bgColor)
                            : colors.surfaceElevated,
                          borderColor: selected ? sc.dotColor : colors.border,
                        },
                      ]}
                    >
                      <Text style={[s.chipText, { color: selected ? sc.color : colors.textSecondary }]}>
                        {sc.label}
                      </Text>
                    </TouchableOpacity>
                  );
            ...
            <View style={s.field}>
              ...
              <View style={s.tagInputRow}>
                <TextInput
                  ...
                  returnKeyType="done"
                />
                <TouchableOpacity onPress={addTag} style={[s.addTagBtn, { backgroundColor: colors.primary }]}>
                  <Text style={[s.addTagBtnText, { color: colors.primaryFg }]}>Add</Text>
                </TouchableOpacity>
              </View>
              {form.tags.length > 0 && (
                <View style={s.tagsWrap}>
                  {form.tags.map((tag) => (
                    <View key={tag} style={[s.tagChip, { backgroundColor: colors.surfaceElevated, borderColor: colors.border }]}>
                      <Text style={[s.tagChipText, { color: colors.textSecondary }]}>{tag}</Text>
